 ...
 */
final class Version20181204125427 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, compte_id INT NOT NULL, nom VARCHAR(50) NOT NULL, prenom VARCHAR(50) NOT NULL, date_naiss DATE NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3F2C56620 (compte_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE compte (id INT AUTO_INCREMENT NOT NULL, login VARCHAR(50) NOT NULL, mdp VARCHAR(50) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE reponse (id INT AUTO_INCREMENT NOT NULL, responsable_id INT NOT NULL, reclamation_id INT NOT NULL, message VARCHAR(255) NOT NULL, date DATE NOT NULL, INDEX IDX_5FB6DEC753C59D72 (responsable_id), INDEX IDX_5FB6DEC72D6BA2D9 (reclamation_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE reclamation (id INT AUTO_INCREMENT NOT NULL, usager_id INT NOT NULL, etat_id INT NOT NULL, objet VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, date_ouv DATE NOT NULL, date_ferm DATE NOT NULL, INDEX IDX_CE6064044F36F0FC (usager_id), INDEX IDX_CE606404D5E86FF (etat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE usager (id INT AUTO_INCREMENT NOT NULL, adresse VARCHAR(100) NOT NULL, copos VARCHAR(10) NOT NULL, ville VARCHAR(50) NOT NULL, mail VARCHAR(50) NOT NULL, tel VARCHAR(15) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE levee (id INT AUTO_INCREMENT NOT NULL, container_id INT NOT NULL, date_levee DATE NOT NULL, poids DOUBLE PRECISION NOT NULL, INDEX IDX_E33674B7BC21F742 (container_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE tarif (id INT AUTO_INCREMENT NOT NULL, type_dechet_id INT NOT NULL, date DATE NOT NULL, tarif DOUBLE PRECISION NOT NULL, INDEX IDX_E7189C9B93D2352 (type_dechet_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
