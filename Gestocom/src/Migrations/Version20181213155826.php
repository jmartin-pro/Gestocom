 ...
 */
final class Version20181213155826 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur DROP archive');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE utilisateur ADD archive TINYINT(1) NOT NULL');
    }
}
